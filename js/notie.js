				...
				return function (e) {
					...
					var a = "function" == typeof Symbol && "symbol" === i(Symbol.iterator) ? function (e) {
						...
						T = t.confirm = function (e, t, n) {
							var s = e.text,
								a = e.submitText,
								i = void 0 === a ? "<i class='mdi mdi-checkbox-marked-circle-outline'></i> Yes" : a,
								c = e.cancelText,
								o = void 0 === c ? "<i class='mdi mdi-close-circle-outline'></i> Cancel" : c,
								l = e.submitCallback,
								d = e.cancelCallback,
								u = e.position,
						...
						M = function (e, t, n) {
							var i = e.text,
								c = e.submitText,
								o = void 0 === c ? "<i class='mdi mdi-checkbox-marked-circle-outline'></i> Update" : c,
								l = e.cancelText,
									d = void 0 === l ? "<i class='mdi mdi-close-circle-outline'></i> Cancel" : l,
								u = e.submitCallback,
								m = e.cancelCallback,
								v = e.position,
